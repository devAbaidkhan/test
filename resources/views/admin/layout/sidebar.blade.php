		...
		<div id="sidebar" class="app-sidebar">
			...
			<div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
				...
				<div class="menu">
					...
					<div class="menu-header">Notification | User | Partner</div>
					<div class="menu-item">
					...
					<div class="menu-item">
						<a href="{{route('Notification_to_store')}}" class="menu-link">
							<span class="menu-icon"><i class="fa fa-bell"></i></span>
							<span class="menu-text">To Partners</span>
						</a>
					</div>
				     <div class="menu-divider"></div>
					<div class="menu-header">Franchise</div>
					{{-- <div class="menu-item">
					...
					<div class="menu-divider"></div>
					<div class="menu-header">Role | Permissions</div>
						<div class="menu-item">
