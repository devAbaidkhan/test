...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      <a class="btn btn-success m-auto" style="float: right;" href="{{route('resturantAddproductaddon', $id)}}">Add
        Addon</a>
        @endif
    </div>
    <div class="card-body">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="{{route('resturantEditproductaddon',$products->id)}}"
                ...
                <button type="button" style="width: 28px; padding-left: 6px;" class="btn btn-danger" data-toggle="modal"
                  data-target="#exampleModal{{$products->id}}"><i class="fa fa-trash"></i></button>
                  @endif
              </td>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <a href="{{route('deleteproductaddon',$products->id)}}" class="btn btn-primary">Delete</a>
      </div>
    </div>
  </div>
</div>
