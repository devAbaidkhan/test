    ...
    <div class="col-md-10 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          @endif
          <form class="forms-sample" action="{{route('restaurant.campaign.join.store')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            <nav>
            ...
            <div class="tab-content" id="nav-tabContent">
              ...
              <div class="tab-pane fade" id="nav-products" role="tabpanel" aria-labelledby="nav-products-tab">
                ...
                @include('resturant.campaign.campaign_types.buy_1_get_1_free')
                @elseif($campaign->campaign_type_id==2 || $campaign->campaign_type_id==3)
                @include('resturant.campaign.campaign_types.type_2_&_3')
                @endif
              </div>
            ...
            <div class="form-group mt-2">
              ...
              <input type="hidden" value="{{ $campaign->campaign_type_id }}" name="campaign_type_id">
