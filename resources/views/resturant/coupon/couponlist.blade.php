  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      ...
      @if (count($errors) > 0)
                  ...
                  @endif
              @endif
 @if (permission('create-coupon'))
        <a class="btn btn-success m-auto" style="float: right;" href="{{route('resturantcoupon')}}">Add Coupon</a>
        @endif
    </div>
    <div class="card-body">
      <div class="table-responsive">
        @if (permission('view-coupon-list '))
