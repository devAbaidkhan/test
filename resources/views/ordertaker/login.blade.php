	...
	<div id="app" class="app app-full-height app-without-header">
		...
		<div class="login">
			...
			<div class="login-content">
				...
				@endif
				@endif
				<form class="user" id="login_form" method="post" action="{{route('ordertaker.check.login')}}">
					{{csrf_field()}}
					<h1 class="text-center">Ordertaker Sign In</h1>
					<div class="text-muted text-center mb-4">
						For your protection, please verify your identity.
					</div>
					<div class="form-group">
						<label>Email Address</label>
						<input type="email" class="form-control form-control-lg fs-15px" value="" name="email"
