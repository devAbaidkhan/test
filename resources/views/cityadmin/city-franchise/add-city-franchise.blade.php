...
<div class="content-wrapper">
  <div class="row">
    ...
    <div class="col-md-10 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Add City Franchise</h4>
          @if (count($errors) > 0)
          @if($errors->any())
          ...
          @endif
          @endif
          <form class="forms-sample" action="{{route('city-franchise.store')}}" method="post" enctype="multipart/form-data">
            {{csrf_field()}}
            ...
            <div class="form-group">
              ...
              <select class="form-control select2" id="currency" name="currency" required>
                ...
                <option value="{{$currency['iso']['code']}}" > {{$currency['iso']['code'].' ('.$currency['name'].') '}}</option>
                @endif
            ...
            <div class="input-group">
              <div class="input-group-prepend">
                <span class="input-group-text" id="cityadmin_phone_prefix">{{ Session::get("franchise_admin")->dialling_code }}</span>
              </div>
