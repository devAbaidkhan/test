    ...
    <div class="col-md-8 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          @endif
          <form class="forms-sample" action="{{route('update-delivery_boy',$delivery_boy->delivery_boy_id)}}"
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputName1" name="delivery_boy_phone"
                value="{{$delivery_boy->delivery_boy_phone}}" requirment>
            </div>

           {{--  <div class="form-group">
              <label for="exampleInputName1">Delivery Boy Comission</label>
              <input type="text" class="form-control" id="exampleInputName1" name="delivery_boy_comission"
                value="{{$delivery_boy->dboy_comission}}" requirment>
            </div> --}}
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputName1" name="password2"
                placeholder="retype password" requirment>
            </div>
            <div class="form-group">
              <label for="exampleFormControlSelect3">Choose Partner</label><br>
              ...
              <select style="border:1px solid gray" name="vendor_id[]" class="form-control" multiple requirment>
                ...
                <?php 
                                               foreach($delivery_boy_vendor as $boy_assigns){
                                                ...
                                                {?>
                <option value="<?= $store->vendor_id ?>"
                  <?php if(in_array($store->vendor_id, $vendor_id)){ echo "selected"; } ?>><?= $store->vendor_name ?>
                </option>
                <?php } ?>
              </select>
            </div>
