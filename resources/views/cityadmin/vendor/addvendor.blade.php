    ...
    <div class="col-md-10 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          ...
          @endif
          @endif
          <form class="forms-sample" action="{{route('AddNewvendor')}}" id="partner_form" method="post"
            ...
            <div class="form-group">
              ...
              <div class="input-group col-xs-12">
                <input type="file" id="vendor_img" name="vendor_img" class="file-upload-default" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group col-xs-12">
                <input type="file" name="main_img" id="main_img" class="file-upload-default" required>
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="exampleInputName1" name="owner_name"
            ...
            <div class="form-group">
              ...
              <input type="email" class="form-control" id="exampleInputName1" name="vendor_email"
                placeholder="Enter Email">
            </div>
            <div class="form-group">
              <label for="exampleInputName1">Partner Phone</label>
              <input type="text" class="form-control" id="exampleInputName1" name="vendor_phone"
            ...
            <div class="form-group">
              ...
              <input type="number" class="form-control" id="exampleInputName1" name="range"
                placeholder="How many KM you Delivered">
            </div>
            <div class="form-group">
              <label for="exampleInputName1">Password</label>
              <input type="text" class="form-control" id="exampleInputName1" name="password1"
                placeholder="Enter password">
            </div>

            <div class="form-group">
              <label for="exampleInputName1">Confirm Password</label>
              <input type="text" class="form-control" id="exampleInputName1" name="password2"
...
<script src="https://maps.googleapis.com/maps/api/js?key={{$map}}&callback=initMap&libraries=places&v=weekly" async>
</script>
  ...
  function readFile(input) {
    if (input.files && input.files[0]) {
      ...
      reader.onload = function (e) {
        ...
        $('#main_image_demo').addClass('ready');
        $('#mainImageModal').modal('show');
