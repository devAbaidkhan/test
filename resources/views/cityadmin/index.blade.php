...
<div class="container-fluid">
    ...
    <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="d-flex">
                                        <div class="mr-auto">
                                            ...
                                            <h3 class="text-white mt-n1 mb-1">{{$currency->currency_sign}}{{$total_cash}}
                </h3>
        ...
        <div class="mt-3 mb-2">
            <a href="#" class="btn btn-yellow btn-rounded btn-sm pl-5 pr-5 pt-2 pb-2 fs-14px font-weight-600"><i
                    class="fa fa-wallet mr-2 ml-n2"></i>Download Report</a>
        </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-orange"
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="text-white-transparent-8 mb-4"></i> here is the count of total<br />Confirmed Order
                    </div>
            ...
            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal" style="min-height: 202px;">
                <!-- BEGIN card-img-overlay -->
                <div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
                    <img src="{{url('assets/img/icon/visitor.svg')}}" alt="" class="ml-auto d-block mb-n3"
                        style="max-height: 105px" />
                </div>
                <!-- END card-img-overlay -->
                ...
                <!-- BEGIN card-body -->
                <div class="card-body position-relative">
                    <h5 class="text-white-transparent-8 mb-3 fs-16px">Total Partnes</h5>
                    <h3 class="text-white mt-n1">0</h3>
                    <div class="progress bg-black-transparent-5 mb-2" style="height: 6px">
                        <div class="progrss-bar progress-bar-striped bg-white" style="width: 50%"></div>
                    </div>
                    <div class="text-white-transparent-8 mb-4"></i>here all your partners <br />add by Franchise Admin
                    </div>
        ...
        <div class="col-sm-6">
            ...
            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-pink" style="min-height: 202px;">
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="text-white-transparent-8 mb-4"></i> here is the count<br /> of all the completed orders
                    </div>
            ...
            <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo"
                ...
                <!-- BEGIN card-img-overlay -->
                <div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
                    <img src="{{url('assets/img/icon/browser.svg')}}" alt="" class="ml-auto d-block mb-n3"
                        style="max-height: 105px" />
                </div>
                <!-- end card-img-overlay -->
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="text-white-transparent-8 mb-4"></i>here is the count <br />of all the delivery boys
                    </div>
