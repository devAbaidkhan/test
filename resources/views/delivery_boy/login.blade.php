		...
		<div class="login">
			...
			<div class="login-content">
			     @if (count($errors) > 0)
                  ...
                  @endif
              @endif
				<form id="login_form" class="user" method="post" action="{{route('delivery_boy.check.login')}}">
				     {{csrf_field()}}
					<h1 class="text-center">Rider Sign In</h1>
					<div class="text-muted text-center mb-4">
						For your protection, please verify your identity.
					</div>
					<div class="form-group">
						<label>Phone Number</label>
						<input type="text" class="form-control form-control-lg fs-15px" value="" name="delivery_boy_phone" />
					</div>
					<div class="form-group">
						<div class="d-flex">
						...
						<input type="password" class="form-control form-control-lg fs-15px" value="" name="delivery_boy_pass" placeholder="Enter your password" />
					</div>
					<div class="form-group">
