...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="page-header mb-3">
            Hi, {{$delivery_boy->delivery_boy_name}}. <small>here's what's happening with your store today.</small>
        </h1>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-orange"
                        ...
                        <div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
                            <img src="{{asset('assets/img/icon/order.svg')}}" alt="" class="ml-auto d-block mb-n3"
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="text-white-transparent-8 mb-4"></i> here is the count of total<br />Confirmed
                                Order
                            </div>
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal"
                        ...
                        <!-- BEGIN card-img-overlay -->
                        <div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
                            <img src="{{asset('assets/img/icon/visitor.svg')}}" alt="" class="ml-auto d-block mb-n3"
                                style="max-height: 105px" />
                        </div>
                        <!-- END card-img-overlay -->
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="text-white-transparent-8 mb-4"></i>here all your partners <br />add by Franchise
                                Admin
                            </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-pink"
                        ...
                        <!-- BEGIN card-img-overlay -->
                        <div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
                            <img src="{{asset('assets/img/icon/email.svg')}}" alt="" class="ml-auto d-block mb-n3"
                                style="max-height: 105px" />
                        </div>
                        <!-- END card-img-overlay -->
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="text-white-transparent-8 mb-4"></i> here is the count<br /> of all the completed
                                orders
                            </div>
                    ...
                    <div class="card mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-indigo"
                        ...
                        <!-- BEGIN card-img-overlay -->
                        <div class="card-img-overlay mb-n4 mr-n4 d-flex" style="bottom: 0; top: auto;">
                            <img src="{{asset('assets/img/icon/browser.svg')}}" alt="" class="ml-auto d-block mb-n3"
                                style="max-height: 105px" />
                        </div>
                        <!-- end card-img-overlay -->
                        ...
                        <div class="card-body position-relative">
                            ...
                            <div class="text-white-transparent-8 mb-4"></i>here is the count <br />of all the delivery
                                boys
                            </div>
