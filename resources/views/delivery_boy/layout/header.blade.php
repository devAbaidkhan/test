   ...
   <div id="header" class="app-header">
   	...
   	<div class="brand">
   		...
   		<a href="#" class="brand-logo">
   			<img src="{{url('assets/img/logo.png.jpg')}}" alt="" height="150px" />
   		...
   		<div class="menu-item dropdown">
   			...
   			<a href="#" data-toggle="dropdown" data-display="static" class="menu-link">
   				<div class="menu-img online">
   					<img src="{{asset(Session::get('delivery_boy')->delivery_boy_image)}}" alt="" class="mw-100 mh-100 rounded-circle" />
   				</div>
   				<div class="menu-text">{{Session::get('delivery_boy')->delivery_boy_name}}</div>
   			</a>
   			<div class="dropdown-menu dropdown-menu-right mr-lg-3">

   				{{-- <a class="dropdown-item d-flex align-items-center"
   					href="{{route('resturantEditvendor',[$vendor->vendor_id])}}">Edit Profile <i
   						class="fa fa-user-circle fa-fw ml-auto text-gray-400 f-s-16"></i></a> --}}

   				<div class="dropdown-divider"></div>
   				<a class="dropdown-item d-flex align-items-center" id="logout_btn" href="javascript:;">Log Out
   					<i class="fa fa-toggle-off fa-fw ml-auto text-gray-400 f-s-16"></i></a>
   			</div>
   		</div>
   	</div>
   	<!-- END menu -->
